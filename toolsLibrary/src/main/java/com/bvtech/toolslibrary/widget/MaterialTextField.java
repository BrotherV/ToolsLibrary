...
public class MaterialTextField extends FrameLayout {
    ...
    public void reduce() {
        if (expanded) {
            final int heightInitial = getContext().getResources().getDimensionPixelOffset(R.dimen.tl_cardHeight_final);
    ...
    public void setImageResources(int res){
    ...
    protected void handleAttributes(Context context, AttributeSet attrs) {
        try {
            TypedArray styledAttrs = context.obtainStyledAttributes(attrs, R.styleable.WidgetAttributes);

            {
                ANIMATION_DURATION = styledAttrs.getInteger(R.styleable.WidgetAttributes_tl_animationDuration, 400);
            }
            {
                OPEN_KEYBOARD_ON_FOCUS = styledAttrs.getBoolean(R.styleable.WidgetAttributes_tl_openKeyboardOnFocus, false);
            }
            {
                labelColor = styledAttrs.getColor(R.styleable.WidgetAttributes_tl_labelColor, -1);
            }
            {
                imageDrawableId = styledAttrs.getResourceId(R.styleable.WidgetAttributes_tl_image, -1);
            }
            {
                cardCollapsedHeight = styledAttrs.getDimensionPixelOffset(R.styleable.WidgetAttributes_tl_cardCollapsedHeight, context.getResources().getDimensionPixelOffset(R.dimen.tl_cardHeight_initial));
            }
            {
                hasFocus = styledAttrs.getBoolean(R.styleable.WidgetAttributes_tl_hasFocus, false);
            }
            {
                backgroundColor = styledAttrs.getColor(R.styleable.WidgetAttributes_tl_backgroundColor, -1);
            }
    ...
    protected void onFinishInflate() {
        ...
        addView(LayoutInflater.from(getContext()).inflate(R.layout.tools_library_mtf_layout, this, false));
        ...
        final int expandedHeight = getContext().getResources().getDimensionPixelOffset(R.dimen.tl_cardHeight_final);
